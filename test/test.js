...
(async () => {
  ...
  for (let i = 0; i < k; i++) {
    ...
    const possibility = PossibilityCalculator.calculate({
      ...
      materialNames: '博根,大熊座,樱,休 哈利路亚,洪吉童,石头人,苏打服务器,易司令,鑫'.split(/\s*[，。；,.;|]\s*/g)
    });
    console.log(PossibilityCalculator.format({
      levelCalculateSynthesisLinkInfos: possibility,
      showMax: 1,
    }));
    tc += Date.now() - st;
  }
  ...
  //     targetName: '宇宙意志',
  //     materialNames: '被感染的海燕,僵尸，僵尸尸尸，僵尸尸尸，僵尸尸尸，圣堂星际女猎手，圣堂星际女猎手，坏叔叔，坏弗拉德，大史莱姆，她她她，灰人艺术大师,程序员文加，董卓，蒂凡尼，薇薇安，虫先生，虫女士。虫女士，麦当劳，麦当劳，易司令，丘比特骑兵'.split(/\s*[\s，。；,.;|]\s*/g)
  //   });
  //   console.log(SynthesisCalculator.format({
  //     calculateSynthesisLinkInfos: synthesis,
  //     showMax
  //   }));
