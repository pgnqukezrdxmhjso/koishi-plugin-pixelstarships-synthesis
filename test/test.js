(async () => {
  ...
  for (let i = 0; i < k; i++) {
    ...
    const possibility = await PossibilityCalculator.calculate({
      targetLevel: 7,
      materialNames: '虫女士 美杜莎 虫族船 狡猾的女孩 克雷先森 猫男 宇航员 男护士 僵尸，僵尸尸尸，僵尸尸尸，僵尸尸尸，圣堂星际女猎手，圣堂星际女猎手，坏叔叔，坏弗拉德，大史莱姆，她她她，灰人艺术大师,程序员文加，董卓，蒂凡尼，薇薇安，虫先生，虫女士。虫女士，麦当劳，麦当劳，易司令，丘比特骑兵'.split(/\s*[\s，。；,.;|]\s*/g)
